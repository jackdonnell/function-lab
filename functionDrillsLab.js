...
function nameCheck (nameToCheck) {
  let NAMEPRAM = nameToCheck
  if (nameToCheck === 'Steven') {
    return 'What is up Steven?'
  }else if (nameToCheck === 'Bryan') {
    return 'Hey Bryan!'
  }else {
    return `Cool name, ${NAMEPRAM}`
  }
}
...
colorRating = console.log(faveColorFinder('black'))
...
let oddChecker = console.log(thatsOdd(22))
...
console.log(emailCheck('jackdonnell74@gmail.com'))
...
////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0,1,2,3,4,7,5,6,8,7]
/*
